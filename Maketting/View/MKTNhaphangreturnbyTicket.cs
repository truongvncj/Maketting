...
namespace Maketting.View
{
    public partial class MKTNhaphangreturnbyTicket : Form
    {
        ...
        public void loaddetailreturnTicket()
        {
        ...
        public MKTNhaphangreturnbyTicket(View.Main Main, string ticketserri)
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)  // new phieu 
        {
...

            {
                ...
                dataGridViewLoaddetail.Rows[idrow].Cells["Return_Quantity"].Style.BackColor = System.Drawing.Color.White;
        ...
        {
            bool kq = Model.MKT.Deletephieuload(this.gatepass, this.storelocation);
            Model.MKT.restatusphieuLoadingtoCRT();
            ...
            if (kq)
            {
                MessageBox.Show("Delete " + this.gatepass.ToString() + " done !", "Thông báo ", MessageBoxButtons.OK, MessageBoxIcon.Information);
        ...
        private void button1_Click_1(object sender, EventArgs e)
        {
            ...
            var rptMKTdetailmk = from pp in dc.tbl_MKt_Listphieudetails
                                 where pp.ShipmentNumber == this.gatepass && pp.ShippingPoint == this.storelocation
