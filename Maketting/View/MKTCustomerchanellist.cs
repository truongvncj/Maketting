...
namespace Maketting.View
{
    ...
    public partial class MKTCustomerchanellist : Form
    {
        ...
        public MKTCustomerchanellist(int lainghiepvu, int id) // int = 1 xóa; int = 2 sửa ; int = 3 tao mới; int = 4 vừa sửa+ xóa
        {
            InitializeComponent();
            ...
            if (lainghiepvu == 4) // xóa + sua
            {
                ...
                var item = (from p in dc.tbl_MKT_CustomerChanels
                            where p.id == id
                ...
                if (item != null)
                {
                    ...
                    txtma.Text = item.Chanel_code;
                    txtten.Text = item.Chanel_name;
        ...
        private void btxoa_Click(object sender, EventArgs e)
        {
            ...
            var rs1 = (from p in dc.tbl_MKT_CustomerChanels
                       where p.id == this.id
                       select p).FirstOrDefault();
            ...
            if (rs1 != null)
            {
                ...
                dc.tbl_MKT_CustomerChanels.DeleteOnSubmit(rs1);
                dc.SubmitChanges();
                this.Close();
        ...
        private void btupdate_Click(object sender, EventArgs e)
        {
            ...
            if (maCT != "")
            {
                ...
                var rs = (from p in db.tbl_MKT_CustomerChanels
                          where p.Chanel_code == maCT
                ...
                if (rs != null)
                {
                    rs.Chanel_code = this.maCT;//= this.txtma.Text;
                    rs.Chanel_name = this.tenCT;//= this.txtten.Text;
        ...
        private void btnew_Click(object sender, EventArgs e)
        {
            ...
            tbl_MKT_CustomerChanel p = new tbl_MKT_CustomerChanel();

            p.Chanel_code = this.maCT;//= this.txtma.Text;
            p.Chanel_name = this.tenCT;//= this.txtten.Text;
            ...
            db.tbl_MKT_CustomerChanels.InsertOnSubmit(p);
            db.SubmitChanges();
            this.Close();
