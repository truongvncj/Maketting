...
namespace Maketting.View
{
    ...
    public partial class MKTVTDanhsacIOtemp : Form
    {
        ...
        public DataGridView   dataGridViewIO { get; set; }
        ...
        public MKTVTDanhsacIOtemp(int lainghiepvu, int id, string ProgrameIDDocno, DataGridView dataGridViewIO ) // int = 1 xóa; int = 2 sửa ; int = 3 tao mới; int = 4 vừa sửa+ xóa
        {
            InitializeComponent();
            string connection_string = Utils.getConnectionstr();
            LinqtoSQLDataContext dc = new LinqtoSQLDataContext(connection_string);
            this.dataGridViewIO =    dataGridViewIO;
            chon = false;
        ...
        private void btnew_Click(object sender, EventArgs e)
        {
            ...
            tbl_MKT_IO_ProgrameTMP p = new tbl_MKT_IO_ProgrameTMP();
            ...
            db.tbl_MKT_IO_ProgrameTMPs.InsertOnSubmit(p);
            db.SubmitChanges();
            this.Close();



            var Programelist = from pp in db.tbl_MKT_IO_ProgrameTMPs
