...
namespace Maketting.View
{
    ...
    // public partial
    public partial class MKTInputchange : Form
    {
        ...
        public MKTInputchange(string lbheader, string lbsub, LinqtoSQLDataContext db, string tblnamemain, string tblnamesub, System.Type Typeofftablemain, System.Type Typeofftablsub, String IDmain, String IDsub, string Username)//;//, string username, int codeinput
        {
            InitializeComponent();
      ...
      //      this.btrigh.Visible = false;
            ...
            if (tblnamesub == "tbl_Temp")
            {
                ...
                btstoreright.Visible = true;


            }
            else
            {
                btstoreright.Visible = false;
