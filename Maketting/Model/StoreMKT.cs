...
namespace Maketting.Model
{
    class StoreMKT
    {
        ...
        public void InputBeginstoredetailwithlocationfuction(string shipingpoint)
        {
            ...
            theDialog.Title = "Open Excel File Store End with Location excel";
            ...
            if (theDialog.ShowDialog() == DialogResult.OK)
            {
                ...
                Thread t1 = new Thread(InputBeginstoredetailwithlocation);
